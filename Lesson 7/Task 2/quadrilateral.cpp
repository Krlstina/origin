    ...
    cornerA{ cornerA }, cornerB{ cornerB }, cornerC{ cornerC }, cornerD{ cornerD }, name{ name }
{
    ...
    {
        throw CreationError("Ошибка создания фигуры \"" + name + "\"! Причина: количество сторон не равно 4");
    }
    if (cornerA + cornerB + cornerC + cornerD != 360)
    {
        throw CreationError("Ошибка создания фигуры \"" + name + "\"! Причина: сумма углов не равна 360");
    }
}
...
{
    std::cout << "Фигура \"" << quadrilateral->getName() << "\" создана: " << std::endl;
